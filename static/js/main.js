    ...
    e = {
      ...
      9269: function (t, e, n) {
        ...
        e.Z = (t, e) => {
          for (let n = 0; n < t.length; n++)
            void 0 !== t[n] &&
              ((t[n]._parent = e),
              (t[n]._ref = (0, r.Z)(t[n])._ref),
              t[n - 1] &&
                ((t[n]._previous = t[n - 1]._ref),
      ...
      2319: function (t, e, n) {
        ...
        e.Z = (t) => {
          ...
          if (t.props) {
            var n, a;
            for (let n in t.props) (0, o.Z)(e, { name: n, value: t.props[n] });
            (null === (n = t.props.animate) || void 0 === n
              ? void 0
              : n.onEnter) &&
              (0, o.Z)(e, {
                name: "class",
                value: ""
                  .concat(t.props.class, " animate-")
                  .concat(
                    null === (a = t.props.animate) || void 0 === a
                      ? void 0
                      : a.onEnter
                  ),
              });
          ...
          return (
            (t._ref = e),
            t.children && t.children.length && (0, r.Z)(t.children, t._ref),
            t
          );
        };
      },
      ...
      4212: function (t, e, n) {
        ...
        e.Z = function (t, e) {
          ...
          if ("animate" !== n)
            if ("class" === n) t.className = o;
            else if ("style" === n) for (let e in o) t.style[e] = o[e];
            else
              n.match(/checked|selected|disabled/)
                ? o && !1 !== o
                  ? t.setAttribute(n, !0)
                  : t.removeAttribute(n)
                : "focus" === n && o
                ? ((r._O.focus = t), (r._O.focusPosition = o))
                : "value" === n
                ? (t.value = o || "")
                : ((n = n.match(/action|detail|key|cmpt/)
                    ? "data-".concat(n)
                    : n),
                  "data-detail" === n && a()(o)
                    ? t.setAttribute(n, JSON.stringify(o))
                    : t.setAttribute(n, o || ""));
        };
      },
      4576: function (t, e, n) {
      ...
      6662: function (t, e, n) {
        "use strict";
        n(4576), n(2784), n(9785), n(3749), n(3386);
      },
      6693: function (t, e, n) {
        "use strict";
        n.d(e, {
        ...
        class o extends Error {
          constructor(t) {
            super(
              t.statusText || 0 === t.status || t.status
                ? t.status
          ...
          async createRequest(t, e, n, r) {
            let c =
              arguments.length > 4 && void 0 !== arguments[4]
                ...
                : {};
            const s = {
              headers: { "X-Requested-With": "Fetch", ...r },
              method: t,
            };
            null !== n && (s.body = n);
            const u = await fetch(e, { ...s, ...c });
            if (!u.ok)
              throw u.status >= 400 && u.status <= 499
                ? new a(u)
                : u.status >= 500 && u.status <= 599
                ? new i(u)
                : new o(u);
            return u;
          }
        ...
        e.Z = async (t, e, n, i) => {
          if (
            ...
            if (
              ...
              (n.status = e.status),
              r.has("Content-Type") &&
                "application/json" === r.get("Content-Type"))
            ) {
              const t = await e.json();
              (n.json = t),
                400 === e.status &&
                  "invalid_request_payload" === t.name &&
                  t.violations &&
                  (n.fieldErrors = t.violations);
            }
          }
          (0, r.W)("request", "".concat(e, "_ERROR"), n),
            (0, a.WI)("request", "".concat(e, "_ERROR"), n);
        };
      },
      4957: function (t, e, n) {
        "use strict";
        ...
        e.Z = async (t) => {
          ...
          try {
            ...
            return void (0, o.Z)(t, n, v, p);
          }
          v.status =
            (null === (e = m) || void 0 === e ? void 0 : e.status) || null;
          try {
            v.json = await m.json();
          } catch (t) {}
          (0, a.W)("request", "".concat(n, "_SUCCESS"), v),
            (0, i.WI)("request", "".concat(n, "_SUCCESS"), v);
        };
      },
      8785: function (t, e, n) {
        "use strict";
          ...
          switch (
            ...
            case "COURSES/LIST": {
              ...
              window.history.replaceState(
                null,
                null,
                "".concat(window.location.pathname).concat(i)
              ),
                (0, a.Z)({
            ...
            case "COURSES/RETRIEVE":
              (0, a.Z)({
                action: t,
                method: "GET",
                url: "/maestro/overlay/course/"
                  .concat(e.courseId, "?tab=")
                  .concat(e.tab),
              });
              break;
            case "FOLLOWS/ADD":
            case "FOLLOWS/REMOVE":
              (0, a.Z)({
                ...
                method: "POST",
                url: "/ajax/"
                  .concat(t.match(/ADD/) ? "follow" : "unfollow", "/")
                  .concat(e.name, "/")
                  .concat(e.id),
              });
              break;
            ...
            case "GET_REVIEWS_PAGE": {
              ...
              (0, a.Z)({
                ...
                method: "GET",
                url: ""
                  .concat(n, "/maestro/course-reviews/")
                  .concat(e.courseId, "-")
                  .concat(e.start),
                parameters: e,
              });
            ...
            case "UPDATE_CREATE_REVIEW":
              (0, a.Z)({
                ...
                method: "POST",
                url: e.user.loggedIn
                  ? "/user/review/create/".concat(e.courseId)
                  : "/review/save/".concat(e.courseId),
                data: n,
                parameters: e,
              });
              break;
            ...
            case "STUDY_GROUP/COORDINATOR_DEL":
              (0, a.Z)({
                ...
                method: "PUT",
                url: "/api/study-groups/"
                  .concat(e.studyGroupSlug, "/coordinator/")
                  .concat(e.id, "/delete"),
              });
              break;
            ...
            case "STUDY_GROUP/PROGRESS_UPDATE":
              (0, a.Z)({
                ...
                data: n,
                method: "POST",
                url: "/user/study-group/"
                  .concat(
                    window.CC.data.urls.cohortSlug,
                    "/enrollee-list/update-item-progress/"
                  )
                  .concat(e.itemId),
                context: c,
              });
            ...
            case "CLASSROOM/UPDATE_ITEM":
              (0, a.Z)({
                action: t,
                method: "POST",
                url: "/user/classroom-list/"
                  .concat(e.courseId, "/update-item/")
                  .concat(e.itemId),
                data: n,
                fetchOptions: s,
              });
            ...
            case "CLASSROOM/DELETE_LIST":
              (0, a.Z)({
                action: t,
                method: "POST",
                url: "/user/classroom-list/".concat(
                  e.classroomListId,
                  "/delete"
                ),
              });
        ...
        const i = (t) =>
          window.location.pathname.match(/\/cohort/)
            ? "/user/study-group/".concat(t.listId, "/list")
            : t.listId
            ? "/user/lists/".concat(t.listId)
            : "/user/education-list";
      },
      6848: function (t, e) {
        "use strict";
            ...
            .concat(
              {
                ...
                notice:
                  "bg-blue-xlight color-charcoal border-all border-blue-light",
              }[t.type || "notice"],
      ...
      5982: function (t, e, n) {
        ...
        const s = (t, e, n) => {
          ...
          (r.data = { name: e, detail: n }), document.dispatchEvent(r);
        };
        e.Z = class {
          constructor() {
            const t = this;
            (t.handlers = []),
              ...
              window.addEventListener(
                ...
                function (e) {
                  c(
                    { originalEvent: e, name: "load:WINDOW", target: e.target },
                    t.handlers
                  );
                },
                !0
      ...
      9894: function (t, e, n) {
        ...
        const i = [{}],
          ...
          u = (t) => {
            const e = s();
            i.push({ ...e, ...t }), i.length >= 6 && i.shift();
          },
          l = () =>
            JSON.stringify(c()) !==
            JSON.stringify(JSON.parse(JSON.stringify(i[i.length - 2]))),
          f = function (t, e, n) {
            let r =
              !!(arguments.length > 3 && void 0 !== arguments[3]) &&
              arguments[3];
            document
              .querySelectorAll('[data-template="'.concat(t, '"]'))
              .forEach((t) => {
                const i = document.createElement("div"),
                  c = r ? e : o().sanitize(e);
                (i.innerHTML = c),
                  t.innerHTML.replace(/^\s+|\s+$/g, "") !==
                    i.innerHTML.replace(/^\s+|\s+$/g, "") && (t.innerHTML = c),
                  n && n(t),
                  c.match(/<img/) &&
                    (u({
                      deferred: {
      ...
      8674: function (t, e, n) {
        ...
        const r = [
          ...
          o = (t) => (r[t - 1] ? { name: r[t - 1], number: t } : null),
          a = (t) => {
            if ("string" != typeof t) return null;
            let e = null;
            return (
              r.map((n, r) => {
                n.substring(0, 3).toLowerCase() ===
                  t.substring(0, 3).toLowerCase() &&
                  (e = { name: n, number: r + 1 });
              }),
              e
            );
            ...
            return t.size <= o
              ...
              : (async function (t, e, n) {
                  ...
                  for (let n = 0; i < r; ) {
                    ...
                    (a = (await s.json()).id), (i = c), (c = i + o), (n += 1);
                  }
      ...
      2385: function (t, e, n) {
        ...
        const a = (t, e) => {
          t.setAttribute("aria-invalid", "false"),
            ...
            (0, r.sY)("field-message-".concat(e), "");
        };
        e.Z = (t, e) => {
          const n = document.querySelector('[data-name="'.concat(t, '"]'));
          for (const [t, i] of Object.entries(e)) {
            (0, r.sY)(
              "field-message-".concat(t),
              (0, o.Z)({ type: "error", message: i.join(" ") })
            );
            const e = n.querySelector("#field-message-".concat(t));
            null !== e &&
              e.hasAttribute("data-autohide") &&
              setTimeout(() => {
                (0, r.sY)("field-message-".concat(t));
              }, 5e3);
            ...
            const s = () => {
              a(c, t), c.removeEventListener("input", s);
            };
      ...
      1142: function (t, e, n) {
        ...
        const r = (t, e) => {
          ...
          a = (t) => ({
            then: document.querySelectorAll(t).length
              ? (e) => {
      ...
      7994: function (t, e, n) {
        ...
        const r = (t) => {
            ...
            return (
              (n.shortHand =
                t < 1e6
                  ? "".concat((t / 1e3).toFixed(t % 1e3 != 0), "k")
                  : "".concat((t / 1e6).toFixed(t % 1e6 != 0), "M")),
              t < 1e4 &&
                t > 999 &&
                (n.longHand = ""
                  .concat(e.charAt(0), ",")
          ...
          o = (t) => {
            if (!t || !t.match(/^[0-9]{4}\/(0[1-9]|1[0-2])$/)) return "";
            try {
              const e = t.split("/");
              if (4 == e[0].length)
                return ""
      ...
      9367: function (t, e) {
        ...
        const n = (t, e) =>
          ...
          r = (t, e) =>
            ...
            t.height - e.top >= 0 &&
            t.width - e.left >= 0 &&
            t.height - (e.top + e.height) >= 0 &&
            t.width - (e.left + e.width) >= 0,
          o = (t, e) =>
      ...
      246: function (t, e) {
        ...
        e.Z = (t) => {
          ...
          return (
            !!(
              t.event.clientX > n.left - t.cushion &&
              t.event.clientX < n.left + n.width + t.cushion &&
              t.event.clientY > n.top &&
              t.event.clientY < n.top + n.height + t.cushion
            ) || !(!r || !r.closest(t.container))
          );
        };
      },
      9184: function (t, e, n) {
        ...
        const a = (t) => {
          ...
          c = () => {
            ...
            for (const [n, r] of e) t[n] = r.split(",");
            return t;
          },
          s = (t) => {
      ...
      3744: function (t, e, n) {
        ...
        const a = (t) => !t || 0 === t.length,
          ...
          u = (t) =>
            t.match(/^(https?:\/\/)?((www\.)?youtube\.com|youtu\.?be)\/.+$/);
      },
      1699: function (t) {
        t.exports = (function () {
          "use strict";
          ...
          function J() {
                ...
                (re && re === t) ||
                  ...
                  (qt =
                    "ADD_URI_SAFE_ATTR" in t
                      ? _(O(Vt), t.ADD_URI_SAFE_ATTR)
                      : Vt),
                  (Wt =
                    "ADD_DATA_URI_TAGS" in t
                      ? _(O(Bt), t.ADD_DATA_URI_TAGS)
                      : Bt),
                  ...
                  t.CUSTOM_ELEMENT_HANDLING &&
                    ae(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
                    (Ot.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                  t.CUSTOM_ELEMENT_HANDLING &&
                    ae(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
                  ...
                  Zt &&
                    ((wt = _({}, [].concat(V(D)))),
                    (Tt = []),
                    !0 === Zt.html && (_(wt, A), _(Tt, R)),
                    !0 === Zt.svg && (_(wt, j), _(Tt, I), _(Tt, M)),
                    !0 === Zt.svgFilters && (_(wt, k), _(Tt, I), _(Tt, M)),
                    !0 === Zt.mathMl && (_(wt, C), _(Tt, P), _(Tt, M))),
                  t.ADD_TAGS && (wt === xt && (wt = O(wt)), _(wt, t.ADD_TAGS)),
                  t.ADD_ATTR && (Tt === _t && (Tt = O(Tt)), _(Tt, t.ADD_ATTR)),
                  t.ADD_URI_SAFE_ATTR && _(qt, t.ADD_URI_SAFE_ATTR),
                  t.FORBID_CONTENTS &&
                    (zt === Ht && (zt = O(zt)), _(zt, t.FORBID_CONTENTS)),
                  Ft && (wt["#text"] = !0),
                  Nt && _(wt, ["html", "head", "body"]),
                  wt.table && (_(wt, ["tbody"]), delete St.tbody),
                  i && i(t),
                  (re = t));
              },
            ...
            var fe = function (t) {
                var e = nt(t);
                (e && e.tagName) ||
                  (e = { namespaceURI: Jt, tagName: "template" });
                var n = m(t.tagName),
                  r = m(e.tagName);
                if (t.namespaceURI === $t)
                  return e.namespaceURI === Jt
                    ? "svg" === n
                    : e.namespaceURI === Yt
                    ? "svg" === n && ("annotation-xml" === r || ce[r])
                    : Boolean(ue[n]);
                ...
                if (t.namespaceURI === Jt) {
                  if (e.namespaceURI === $t && !se[r]) return !1;
                  if (e.namespaceURI === Yt && !ce[r]) return !1;
              ...
              be = function (t) {
                var n = void 0;
                if ((ye("beforeSanitizeElements", t, null), ve(t)))
                  return de(t), !0;
                if (v(t.nodeName, /[\u0080-\uFFFF]/)) return de(t), !0;
                var r = ne(t.nodeName);
                if (
                  (ye("uponSanitizeElement", t, {
                    tagName: r,
                    allowedTags: wt,
                  }),
                ...
                if (!wt[r] || St[r]) {
                  if (!St[r] && we(r)) {
                    if (
                      Ot.tagNameCheck instanceof RegExp &&
                      E(Ot.tagNameCheck, r)
                    )
                      return !1;
                    if (
                      Ot.tagNameCheck instanceof Function &&
                      Ot.tagNameCheck(r)
                    )
                      return !1;
                  }
                ...
                return t instanceof s && !fe(t)
                  ? (de(t), !0)
                  : ("noscript" !== r && "noembed" !== r) ||
                    !E(/<\/no(script|embed)/i, t.innerHTML)
                  ? (Ct &&
                      3 === t.nodeType &&
                      ((n = t.textContent),
                      (n = g(n, ht, " ")),
                      (n = g(n, mt, " ")),
                      t.textContent !== n &&
                        (h(e.removed, { element: t.cloneNode() }),
                        (t.textContent = n))),
                    ...
                    !(
                      (we(t) &&
                        ((Ot.tagNameCheck instanceof RegExp &&
                          ...
                          (Ot.tagNameCheck instanceof Function &&
                            Ot.tagNameCheck(t))) &&
                        ((Ot.attributeNameCheck instanceof RegExp &&
                          E(Ot.attributeNameCheck, e)) ||
                          (Ot.attributeNameCheck instanceof Function &&
                            Ot.attributeNameCheck(e)))) ||
                      ("is" === e &&
                        Ot.allowCustomizedBuiltInElements &&
                        ((Ot.tagNameCheck instanceof RegExp &&
                          E(Ot.tagNameCheck, n)) ||
                ...
                if (i) {
                  ...
                  for (a = i.length; a--; ) {
                    ...
                    if (
                      ...
                      (r = c.attrValue),
                      !c.forceKeepAttr && (pe(u, t), c.keepAttr))
                    )
                      if (E(/\/>/i, r)) pe(u, t);
                      else {
                        Ct && ((r = g(r, ht, " ")), (r = g(r, mt, " ")));
                        var f = ne(t.nodeName);
                        if (Ee(f, o, r))
                          try {
                            l
                              ? t.setAttributeNS(l, u, r)
                              : t.setAttribute(u, r),
                              p(e.removed);
                          } catch (t) {}
                      }
              ...
              Te = function t(e) {
                ...
                for (
                  ...
                  ye("uponSanitizeShadowNode", n, null),
                    be(n) || (n.content instanceof o && t(n.content), xe(n));
                ye("afterSanitizeShadowDOM", e, null);
              };
            return (
              (e.sanitize = function (r, a) {
                var i = void 0,
                  s = void 0,
                  u = void 0,
                  l = void 0,
                ...
                if (
                  ...
                  (1 ===
                    (s = (i = he("\x3c!----\x3e")).ownerDocument.importNode(
                      r,
                      !0
                    )).nodeType &&
                    "BODY" === s.nodeName) ||
                  ...
                  if (!(i = he(r))) return It ? null : Mt ? at : "";
                }
                i && Rt && de(i.firstChild);
                for (var p = me(Gt ? r : i); (u = p.nextNode()); )
                  (3 === u.nodeType && u === l) ||
                    be(u) ||
                    (u.content instanceof o && Te(u.content), xe(u), (l = u));
                if (((l = null), Gt)) return r;
                if (It) {
                  if (Pt)
                    for (f = ut.call(i.ownerDocument); i.firstChild; )
                      f.appendChild(i.firstChild);
                  else f = i;
                  return Tt.shadowroot && (f = ft.call(n, f, !0)), f;
                }
                ...
                return (
                  Nt &&
                    ...
                    E(B, i.ownerDocument.doctype.name) &&
                    (h =
                      "<!DOCTYPE " + i.ownerDocument.doctype.name + ">\n" + h),
                  Ct && ((h = g(h, ht, " ")), (h = g(h, mt, " "))),
        ...
        t.exports = function (t, e, n, m, v, g) {
          ...
          if (!(1 & n)) {
            ...
            if (O || S) {
              var A = O ? t.value() : t,
                j = S ? e.value() : e;
              return g || (g = new r()), v(A, j, n, m, g);
            }
          }
          return !!_ && (g || (g = new r()), i(t, e, n, m, v, g));
        };
      },
      9850: function (t, e, n) {
        var r = n(3694),
      ...
      7042: function (t, e, n) {
        ...
        t.exports = function (t, e, n, i, c, s) {
          ...
          for (s.set(t, e), s.set(e, t); ++h < l; ) {
            var g = t[h],
              y = e[h];
            if (i) var b = u ? i(y, g, h, e, t, s) : i(g, y, h, t, e, s);
            if (void 0 !== b) {
              if (b) continue;
              m = !1;
              break;
      ...
      370: function (t, e, n) {
        ...
        t.exports = function (t, e, n, r, u, f, d) {
          switch (n) {
            ...
            case "[object Set]":
              var h = 1 & r;
              if ((p || (p = s), t.size != e.size && !h)) return !1;
              var m = d.get(t);
              if (m) return m == e;
              (r |= 2), d.set(t, e);
      ...
      9584: function (t, e, n) {
        ...
        t.exports = function (t, e, n, a, i, c) {
          ...
          for (var v = s; ++f < l; ) {
            var g = t[(d = u[f])],
              y = e[d];
            if (a) var b = s ? a(y, g, d, e, t, c) : a(g, y, d, t, e, c);
      ...
      1871: function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
          return (
            ...
            function () {
              for (
                var a = arguments, i = -1, c = o(a.length - e, 0), s = Array(c);
                ++i < c;
      ...
      6726: function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
          ...
          function y(e) {
            var n = s,
              r = u;
            return (s = u = void 0), (h = e), (f = t.apply(r, n));
          }
          function b(t) {
          ...
          function x(t) {
            return (d = void 0), g && s ? y(t) : ((s = u = void 0), f);
          }
          function T() {
            var t = o(),
              n = E(t);
      ...
      9783: function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
          ...
          return (
            ...
            r(t, e, { leading: a, maxWait: e, trailing: i })
          );
        };
      },
      1936: function (t, e, n) {
    ...
    (function () {
      ...
      a.IW({
        user: {
          ...
          ...((null === (t = window.CC.data) || void 0 === t
            ? void 0
            : t.user) || {}),
        },
        queryObject: o.aI(),
        ...
        (0, n.E)(a.y0().user.locale),
        i.useHandler((t) => {
          switch (t.name) {
            case "DOMContentLoaded:DOCUMENT":
              s("Essential"),
                ["login", "signup"].indexOf(
            ...
            case "load:WINDOW":
              s("UserActions"),
                ...
                o
                  .px(".catalog-grid__curated-content")
                  .then(() => c("CatalogCuratedContent")),
                window.CC.data && window.CC.data.filters && c("Filters"),
                window.location.pathname.match(
                  /\/user\/onboarding\/(subjects|courses)/
                ) && c("Onboarding"),
                window.location.pathname.match(/\/cohorts\/[a-zA-Z0-9\-]+$/) &&
                  c("StudyGroups"),
                ...
                window.location.pathname.match(/\/course\/|\/review\//) &&
                  s("Reviews"),
                s("Misc"),
                o.px("[data-staff-tools").then(() => c("StaffTools")),
                window.location.pathname.match(/\/getting-started/) &&
                  o.px("[data-tour]").then(() => c("Tour")),
                window.location.pathname.match(/^\/course\/[a-zA-Z0-9\-]+$/) &&
                  (c("CourseTabs"),
                  c("CourseMobileFloatingCta"),
                  c("CollapsableSection")),
                window.location.pathname.match(
                  /\/classroom\/[a-zA-Z0-9\-]+(\/[a-zA-Z0-9]+)?/
                ) && c("Classroom"),
      ...
      const c = (t) => {
          r(7992)("./".concat(t)).then((n) => {
            i.useHandler(n.default),
              (0, e.W)("load", "".concat(t.toUpperCase(), "_MODULE"));
          });
        },
        s = (t) => {
